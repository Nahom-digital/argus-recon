...
| [nmap](https://nmap.org) | `p` | 2a · port scan | Open ports, service versions, OS guess, default scripts, traceroute | port-scan toggle stays locked |
...
| built-in JS parser | `js` | 5 · crawl | Endpoints and secrets inside JavaScript | — |
...
| **passive** | off | Passive enumeration only. Nothing is sent to the target. Rules out the port scan |
